...
import rs.aleph.android.example12.dialog.AboutDialog;
import rs.aleph.android.example12.fragments.CategoryFragment;
	...
	private class DrawerItemClickListener implements ListView.OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			if (position == 0) {
				...
				ft.replace(R.id.list_view,categoryFragment,"Category_Fragment1");
				ft.addToBackStack(null);
				ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
				ft.commit();

               /* Intent categories = new Intent(FirstActivity.this,CategoryActivity.class);
...
// Populates a list of NavigationDrawer items
		...
		drawerItems.add(new NavigationItem(getString(R.string.drawer_category), getString(R.string.drawer_category_long), R.drawable.ic_action_category));
